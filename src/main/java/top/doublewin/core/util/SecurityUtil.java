...
import top.doublewin.core.support.security.BASE64Encoder;
import top.doublewin.core.support.security.coder.*;
...
public final class SecurityUtil {
	...
	public static void main(String[] args) throws Exception {
		System.out.println(SecurityUtil.encryptPassword("quanzhidao023"));
		System.out.println(encryptDes("111111"));
