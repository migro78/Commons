...
import top.doublewin.core.support.security.Hex;
...
public abstract class MDCoder extends SecurityCoder {
	 ...
	 * @throws Exception
	 */
	public static String encodeMD5(String fileUrl) throws Exception{
		return DigestUtils.md5DigestAsHex(ImageUtil.readImageFromUrl(fileUrl));
	}
