...
public class RedisUtil {
    ...
    public boolean lock(String key, String value) {
        boolean ret = setIfAbsent(key, value, 30, TimeUnit.SECONDS);
        if (ret) {
            logger.debug("locking... key is {},value is {}", key, value);
        }
        return ret;
    }
    ...
    public boolean lock(String key, String value,long time) {
        boolean ret = setIfAbsent(key, value, time, TimeUnit.SECONDS);
        if (ret) {
            logger.debug("locking... key is {},value is {}", key, value);
        }
        return ret;
    ...
    public void unlock(String key, String value) {
        value = get(key);
        logger.debug("unlocked... key is {}, value is {}", key, value);
        delete(key);
    }
